...
function injectConsentHTML(detectedCookies, language = 'en') {
  ...
  <path d="M3 3v18h18V3H3zm16 16H5V5h14v14zM8 7h2v6H8V7zm4 2h2v4h-2V9zm4 2h2v2h-2v-2zm-8 6h2v2H8v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2z"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
